...
export default function CartPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {cartItems.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-16 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl shadow-xl border border-gray-200">
          <svg
            className="w-20 h-20 mb-6 text-blue-400 animate-bounce"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          ...
          >
            <path
              ...
              strokeWidth={2}
              d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13l-1.3 5.2a1 1 0 001 1.3h12a1 1 0 001-1.3L17 13M7 13h10m0 0l1.3-5.2M17 13l1.3 5.2"
            />
          </svg>
          ...
          <Link
            href="/"
            className="inline-block bg-blue-500 text-white px-8 py-3 rounded-full font-medium shadow-md hover:bg-blue-600 hover:scale-105 transition-transform duration-200"
          >
            Continue Shopping
          </Link>
        </div>
