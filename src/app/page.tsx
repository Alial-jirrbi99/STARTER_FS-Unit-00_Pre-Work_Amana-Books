...
export default function HomePage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Welcome Section */}
      <section className="text-center bg-gray-200 p-8 rounded-lg mb-12 shadow-md">
        <h1 className="text-5xl font-extrabold text-blue-300 mb-2">
          Welcome to the Amana Bookstore!
        </h1>
        <p className="text-base py-4 text-gray-500">
